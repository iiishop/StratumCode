...
_CHAT_TRANSITIONS = {
    ...
    ChatState.PATCH_PLANNING: {ChatState.IMPLEMENTING, ChatState.SAVING_SESSION, ChatState.COMPLETED, ChatState.FAILED},
    ChatState.IMPLEMENTING: {ChatState.INVESTIGATING, ChatState.VALIDATING, ChatState.SAVING_SESSION, ChatState.COMPLETED},
