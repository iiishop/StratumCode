...
export function useChatTimeline(onAppend) {
  ...
  return {
    ...
    showCodeNav: (message, payload) => appendEvent(message, 'code_nav', payload),
    ...
    showSkill: (message, payload) => appendEvent(message, 'skill', payload),
    showStateTransition: (message, payload) => appendEvent(message, 'state_transition', payload),
    ...
    showInvestigationFacts: (message, payload) => appendEvent(message, 'investigation_facts', payload),
