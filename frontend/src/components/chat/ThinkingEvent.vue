...
.thinking-md { white-space: normal; overflow-x: auto; }
...
.thinking-md :deep(h4),
.thinking-md :deep(h5),
.thinking-md :deep(h6) { margin: 10px 0 4px; color: var(--text-h, #102a5c); font-weight: 650; line-height: 1.3; }
.thinking-md :deep(h1) { font-size: 14.5px; }
...
.thinking-md :deep(:not(pre) > code) { padding: 1px 4px; border-radius: 3px; background: rgba(23, 86, 209, .07); color: var(--accent-text, #1748a3); font: .9em/1.4 var(--mono, monospace); }
...
.thinking-md :deep(hr) { margin: 10px 0; border: 0; border-top: 1px solid var(--border, #d9e3f5); }
.thinking-md :deep(table) { width: max-content; min-width: 100%; margin: 6px 0; border-collapse: collapse; font-size: 11.5px; line-height: 1.5; }
