...
<style scoped>
.agent-result { display: flex; gap: 8px; padding: 2px 3px; color: #526982; font-size: 11px; line-height: 1.55; }.agent-result > span:first-child { color: #6658c7; font-weight: 800; }
