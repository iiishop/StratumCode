...
<style scoped>
.agent-result { display: flex; min-width: 0; gap: 8px; padding: 3px; color: #526982; font-size: 13px; line-height: 1.6; overflow-wrap: anywhere; }.agent-result > span:first-child { flex: 0 0 auto; color: #6658c7; font-weight: 800; }.agent-result > span:last-child { min-width: 0; }
